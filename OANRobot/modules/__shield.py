...
from OANRobot import BOT_ID
from OANRobot.conf import get_int_key, get_str_key

# from OANRobot.db.mongo_helpers.nsfw_guard import add_chat, get_all_nsfw_chats, is_chat_in_db, rm_chat
from OANRobot.pyrogramee.telethonbasics import is_admin
from OANRobot.events import register
from OANRobot import MONGO_DB_URI 
from pymongo import MongoClient
from OANRobot.modules.sql_extended.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from OANRobot import telethn as tbot
...
__help__ = """
<b> Group Guardian: </b>
✪ Captain can protect your group from NSFW senders, Slag word users and also can force members to use English
...
Note: Special credits goes to @Attitude_Network
