...
from OANRobot import StartTime, dispatcher
...
def ping(update: Update, context: CallbackContext):
    ...
    message.edit_text(
        "PONG[👑](https://telegra.ph/file/0ddd19a57f6297b6a2a6d.jpg)!!\n"
...
def pingall(update: Update, context: CallbackContext):
    ...
    reply_msg = "[⏱](https://telegra.ph/file/0ddd19a57f6297b6a2a6d.jpg)Ping results are:\n"
    reply_msg += "\n".join(pinged_list)
