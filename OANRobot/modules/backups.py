...
import OANRobot.modules.sql.notes_sql as sql
from OANRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from OANRobot.__main__ import DATA_IMPORT
from OANRobot.modules.helper_funcs.chat_status import user_admin
from OANRobot.modules.helper_funcs.alternate import typing_action

# from OANRobot.modules.rules import get_rules
import OANRobot.modules.sql.rules_sql as rulessql

# from OANRobot.modules.sql import warns_sql as warnssql
import OANRobot.modules.sql.blacklist_sql as blacklistsql
from OANRobot.modules.sql import disable_sql as disabledsql

# from OANRobot.modules.sql import cust_filters_sql as filtersql
# import OANRobot.modules.sql.welcome_sql as welcsql
import OANRobot.modules.sql.locks_sql as locksql
from OANRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("OANRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("OANRobot{}.backup".format(chat_id), "rb"),
