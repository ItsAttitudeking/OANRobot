...
import telegram
from OANRobot import TIGERS, WOLVES, dispatcher
from OANRobot.modules.disable import DisableAbleCommandHandler
from OANRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from OANRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from OANRobot.modules.helper_funcs.string_handling import split_quotes
from OANRobot.modules.log_channel import loggable
from OANRobot.modules.sql import warns_sql as sql
