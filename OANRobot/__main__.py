...
buttons = [
    [
        InlineKeyboardButton(
            text="⚔️🌹 ᴀᴅᴅ ʏᴏɴᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ⚔️", url="t.me/king_captain_robot?startgroup=true"),
    ],
    [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("OANRobot.modules." + module_name)
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *𝐂𝐚𝐩𝐭𝐚𝐢𝐧*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_✭Caption's licensed under the GNU General Public License v3.0_
                 \n✭Here is the [💾Repository](https://github.com/ItsAttitudeking/OANRobot).
                 \n\n✭If you have any question about yone, let us know at [𝐀𝐭𝐭𝐢𝐭𝐮𝐝𝐞 𝐍𝐞𝐭𝐰𝐨𝐫𝐤](Https://t.me/Attitude_Network) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *𝐂𝐚𝐩𝐭𝐚𝐢𝐧*
                 \nHere is the [Source Code](https://github.com/ItsAttitudeking/OANRobot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
